...
// Source: src/business/domain/payslip/payslip.go
//
// Generated by this command:
//
//	mockgen -source src/business/domain/payslip/payslip.go -destination src/business/domain/mock/payslip/payslip.go
//

// Package mock_payslip is a generated GoMock package.
package mock_payslip
...
func (m *MockInterface) Create(ctx context.Context, param entity.PayslipInputParam) (entity.Payslip, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) CreateMany(ctx context.Context, inputParams []entity.PayslipInputParam) error {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(ctx context.Context, param entity.PayslipParam) (entity.Payslip, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) GetList(ctx context.Context, param entity.PayslipParam) ([]entity.Payslip, *entity.Pagination, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Update(ctx context.Context, updateParam entity.PayslipUpdateParam, selectParam entity.PayslipParam) error {
	m.ctrl.T.Helper()
