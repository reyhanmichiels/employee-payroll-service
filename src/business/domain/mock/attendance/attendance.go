...
// Source: src/business/domain/attendance/attendance.go
//
// Generated by this command:
//
//	mockgen -source src/business/domain/attendance/attendance.go -destination src/business/domain/mock/attendance/attendance.go
//

// Package mock_attendance is a generated GoMock package.
package mock_attendance
...
func (m *MockInterface) Create(ctx context.Context, param entity.AttendanceInputParam) (entity.Attendance, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(ctx context.Context, param entity.AttendanceParam) (entity.Attendance, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) GetList(ctx context.Context, param entity.AttendanceParam) ([]entity.Attendance, *entity.Pagination, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Update(ctx context.Context, updateParam entity.AttendanceUpdateParam, selectParam entity.AttendanceParam) error {
	m.ctrl.T.Helper()
