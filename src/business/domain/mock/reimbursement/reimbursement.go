...
// Source: src/business/domain/reimbursement/reimbursement.go
//
// Generated by this command:
//
//	mockgen -source src/business/domain/reimbursement/reimbursement.go -destination src/business/domain/mock/reimbursement/reimbursement.go
//

// Package mock_reimbursement is a generated GoMock package.
package mock_reimbursement
...
func (m *MockInterface) Create(ctx context.Context, param entity.ReimbursementInputParam) (entity.Reimbursement, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Get(ctx context.Context, param entity.ReimbursementParam) (entity.Reimbursement, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) GetList(ctx context.Context, param entity.ReimbursementParam) ([]entity.Reimbursement, *entity.Pagination, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) Update(ctx context.Context, updateParam entity.ReimbursementUpdateParam, selectParam entity.ReimbursementParam) error {
	m.ctrl.T.Helper()
